...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    std::cout << "Starting TimeApp with ImGui..." << std::endl;
    ...
    while (!done) {
        ...
        ImGui::Begin("Time Display", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse);
        ...
        ImGui::Text("Application running successfully!");
...
// Helper functions to setup Direct3D device
bool CreateDeviceD3D(HWND hWnd) {
    // Setup swap chain
